...
function RegUpdate(id) {
  ...
  // console.log("RegistrationDataArr", RegistrationDataArr[id]);
   document.getElementById("RegFirstName").value=RegistrationDataArr[id].RegFirstName,
   document.getElementById("RegLastName").value=RegistrationDataArr[id].RegLastName,
   document.getElementById("RegNumber").value=RegistrationDataArr[id].RegNumber,
   document.getElementById("RegYourEmail").value=RegistrationDataArr[id].RegYourEmail,
   document.getElementById("ProductList").value=RegistrationDataArr[id].ProductList,
   document.getElementById("RegProductQty").value=RegistrationDataArr[id].RegProductQty,
   document.getElementById("RegProductColor").value=RegistrationDataArr[id].RegProductColor,
   document.getElementById("RegAddress").value=RegistrationDataArr[id].RegAddress,
